...
namespace PruebaMainSoft_2.Controllers
{
    public class AutoresController : Controller
    {
        ...
        public AutoresController(PruebaMainSoftContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido")] Autore autore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido")] Autore autore)
        {
            if (id != autore.Id)
            {
                return NotFound();
